...
class Auth(object):
    ...
    default_messages = dict(
        ...
        is_empty="Este campo no puede ser vacío",
    ...
    def navbar(self, prefix='Welcome', action=None,
        ...
        if self.user_id:  # User is logged in
            ...
            items.append({'name': T('Iniciar Sesión'), 'href': href('login'),
                          'icon': 'icon-off'})
            if 'register' not in self.settings.actions_disabled:
                items.append({'name': T('Registrarse'), 'href': href('register'),
                              'icon': 'icon-user'})
        ...
        def bootstrap3():  # Default web2py scaffolding
            ...
            if self.user_id:
                ...
                self.bar = LI(Anr(T('Iniciar Sesión'),
                                  _href='#', _class="dropdown-toggle",
        ...
        def bare():
            ...
            for i in items:
                if i['name'] == T('Iniciar Sesión'):
                    k = 'login'
                elif i['name'] == T('Registrarse'):
                    k = 'register'
            ...
            if username or settings.cas_provider:
                ...
                db.define_table(
                    ...
                    Field('email', length=512, default='',
                          ...
                          requires=IS_MATCH('[a-z0-9\-]+@usb.ve', error_message='No es un correo valido')),
        ...
        if self.settings.register_verify_password:
            ...
            extra_fields = [
                Field("password_two", "password",
                      ...
                      label=current.T("Confirmar Contraseña"))]
        else:
            extra_fields = []
        form = SQLFORM(table_user,
