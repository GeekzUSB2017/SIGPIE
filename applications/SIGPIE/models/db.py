...
db.define_table('informacion_academica',
                ...
                Field('indice', requires=IS_MATCH('^[1-4].[0-9][0-9][0-9][0-9]|5.0000', error_message='El índice debe estar con el formato: x.xxxx y tener un valor entre 1.0000 - 5.0000')),
