...
db.define_table('carrera',
                ...
                Field('nombre', 'string', requires=IS_NOT_EMPTY(), label='Carrera'),
...
db.define_table('universidad',
                Field('pais', db.pais, requires=IS_IN_DB(db, db.pais.id, '%(nombre)s'), label='Pais Seleccionado'),
                Field('nombre', 'string', requires=IS_NOT_EMPTY(), label='Universidad Seleccionada'),
                Field('convenio', db.convenio, requires=IS_IN_DB(db, db.convenio.id, '%(nombre)s'), label='Programa de Movilidad'),
...
db.define_table('estudiante',
                ...
                Field('cedula', requires=IS_MATCH('^[0-9]{8}$',
                                                  error_message='No es una cedula'), unique=True, label='C.I.'),
                Field('telefono_habitacion', requires=IS_MATCH('^[0-9]{11}$',
                                                               error_message='No es un telefono de habitacion'), label='Telefono Habitacion'),
                Field('telefono_celular', requires=IS_MATCH('^[0-9]{11}$',
                                                            error_message='No es un telefono celular'), label='Telefono Celular'),
                ...
                Field('renuncio','boolean', default=False, label='Status de Renuncia'),
...
db.define_table('informacion_academica',
                ...
                Field('indice', requires=IS_MATCH('^[1-4].[0-9][0-9][0-9][0-9]|5.0000', error_message='El índice debe estar con el formato: x.xxxx y tener un valor entre 1.0000 - 5.0000'), label='Indice'),
